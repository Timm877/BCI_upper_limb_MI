...
def execution(pipeline_type, list_of_freq_lim, freq_limits_names_list, filt_orders, window_sizes, subject):
    ...
    result_path = Path(f'./data/openloop/intermediate_datafiles/preprocess/{subject}_WithSPFilt2')
...
def main():
    for subj in FLAGS.subjects:
        ...
        if 'csp' in FLAGS.pline:
            # filterbank
            list_of_freq_lim = [[[10, 15], [15, 20], [20, 25], [25, 30], [30, 35]]]
