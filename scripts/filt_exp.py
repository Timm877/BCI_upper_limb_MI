...
def main():
    ...
    if 'riemann' in FLAGS.p:
        ...
        list_of_freq_lim = [[[4, 30]], [[4,40]], [[8,30]],  [[8,40]]]
        freq_limits_names_list = [['4_30Hz'], ['4-40Hz'], ['8-30Hz'], ['8-40hz']]
        filt_orders = [2,4]
    if 'deep' in FLAGS.p:
        list_of_freq_lim = [[[4,40]], [[8,30]], [[1,60]], [[4,60]]]
        freq_limits_names_list = [['4-40Hz'], ['8-30Hz'], ['1-60Hz'], ['4-60Hz']]
        filt_orders = [4]
        ...
        for freq_limit_instance in range(len(list_of_freq_lim)):
            ...
            for df in dataset_full:
                ...
                for segment in range(len(X_segmented)):
                    ...
                    if isinstance(segment_filt,int):
            ...
            if 'deep' in FLAGS.p:
                ...
                for lr in [0.0005]: 
                    ...
                    results[f"DL_lr{lr}_{filter_order}_{freq_limits_names}"] = {'final_train_accuracy': train_accuracy[-1],
                    'test_accuracy': val_accuracy[-1], 'filter_order' : filter_order, 
